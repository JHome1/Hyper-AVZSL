...
def args_main(*args, **kwargs):
    ...
    parser.add_argument(
        "--curvature",
        help="curvature or initial curvature",
        default=0.0,
        type=float
    )
    parser.add_argument(
        "--num_curvature",
        help="number of adaptive curvatures in Hyper-multiple",
        default=0,
        type=int
    )
    parser.add_argument(
        "--hyper_framework",
        help="framework",
        choices=["Baseline", "Hyper-alignment", "Hyper-single", "Hyper-multiple"],
        default="Hyper-alignment"
    )
    ###################
