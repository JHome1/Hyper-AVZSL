...
from src.model_improvements import AVCA, Hyper_AVCA
...
def get_evaluation():
    ...
    if args.AVCA==True or args.Hyper_AVCA==True:
    ...
    if  args.ale==False and args.sje==False and args.devise==False and args.apn==False and args.cjme==False and args.AVCA==False and args.Hyper_AVCA==False:
    ...
    elif args.Hyper_AVCA==True:
        model_A = Hyper_AVCA(params_model=model_params, input_size_audio=config.input_size_audio,input_size_video=config.input_size_video, args=args)
    ...
    test(
        ...
        new_model_attention=config.AVCA|args.Hyper_AVCA,
        apn=args.apn,
        args=config
    )
